...
public class ChannelFragment extends Fragment {
    private static String GOOGLE_YOUTUBE_API_KEY = "AIzaSyC_wfEB8MWOFww6NSnoQ7QLIQJJDQYadPs"; //Youtube API Key
    private static String CHANNEL_ID = "UCdY1B4Vvjcfqpqq630SjI2w"; //Man of Water Channel ID
