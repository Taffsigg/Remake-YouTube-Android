...
public class PlayListFragment extends Fragment {
    ...
    private static String PLAYLIST_ID = "PLBpomwUGdYvNCT97xRSEPuQAsiKXwo94k"; //POV Wedge Playlist
    private static String PLAYLIST_GET_URL = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&playlistId=" + PLAYLIST_ID + "&maxResults=20&key=" + GOOGLE_YOUTUBE_API_KEY + "";
